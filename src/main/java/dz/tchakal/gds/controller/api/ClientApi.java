...
@Api(Constant.APP_ROOT+"clients")
public interface ClientApi {

    @PostMapping(value = Constant.APP_ROOT+"clients/create",produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT+"clients/{idClient}",produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT+"clients/{mail}",produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT+"clients",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constant.APP_ROOT + "/clients/delete/{idClient}")
