...
public interface UtilisateurApi {
    ...
    @GetMapping(value = StaticRoot.UTILISATEUR_ENDPOINT_FINDBYID,produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = {StaticRoot.UTILISATEUR_ENDPOINT_FINDBYMAIL, StaticRoot.UTILISATEUR_ENDPOINT_FINDBYMOTPASSE},produces = MediaType.APPLICATION_JSON_VALUE,consumes = MediaType.APPLICATION_JSON_VALUE)
