...
@Api(Constant.APP_ROOT + "/categories")
public interface CategorieApi {

    @PostMapping(value = Constant.APP_ROOT + "/categories/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT + "/categories/{idCategorie}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT + "/categories/{codeCategorie}", produces = MediaType.APPLICATION_JSON_VALUE)
 ...
 @GetMapping(value = Constant.APP_ROOT + "/categories/{designation}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constant.APP_ROOT + "/categories/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constant.APP_ROOT + "/categories/delete/{idCategorie}")
